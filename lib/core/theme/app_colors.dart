...
// AppColors - all the app's colors in one place. Named once, reused everywhere.
// Chosen to be calm and readable for older users managing blood pressure.
class AppColors {
  // Primary greens
  ...
  // Accent gold (achievements, not alarming)
  ...
  // Viridis palette (kept for backward compatibility and health-pillar colors)
...
// Returns a color for a progress bar: dark green early, shifting to gold near the end.
